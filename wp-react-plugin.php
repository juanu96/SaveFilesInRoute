<?php
/*
Plugin Name: vegalink
Description: Use the [vegalink] shortcode to display the plugin
Version: 0.0.1
...
$vegalink = new vegalink();
$vegalink->init();

function vegalink_shortcode( $atts ) {
  ...
  return "<div id='vegalink'></div>";
}

add_shortcode( 'vegalink', 'vegalink_shortcode' );